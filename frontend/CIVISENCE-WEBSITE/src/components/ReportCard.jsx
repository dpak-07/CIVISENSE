...
export default function ReportCard({
    ...
    return (
        <>
            <article className="report-card card ring-1 ring-indigo-300/20 hover:-translate-y-1 transition-all duration-300">
                ...
                <div className="report-card__body">
                    ...
                    <div className="report-card__path">
                        ...
                        <div className="report-card__path-actions">
                            {imageUrl ? (
                                <button
                                    type="button"
                                    className="btn btn-ghost btn-sm report-card__path-button"
                            ...
                            {aiDetectedImageUrl ? (
                                <button
                                    type="button"
                                    className="btn btn-ghost btn-sm report-card__path-button report-card__path-button--ai"
            ...
            >
                {previewImageUrl ? <img src={previewImageUrl} alt={complaint.title} className="image-preview-modal__image" /> : null}
            </Modal>
        </>
    );
}
